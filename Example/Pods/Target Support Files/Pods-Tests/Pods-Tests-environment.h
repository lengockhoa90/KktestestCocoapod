...
// KktestestCocoapod
#define COCOAPODS_POD_AVAILABLE_KktestestCocoapod
#define COCOAPODS_VERSION_MAJOR_KktestestCocoapod 0
#define COCOAPODS_VERSION_MINOR_KktestestCocoapod 1
#define COCOAPODS_VERSION_PATCH_KktestestCocoapod 0
